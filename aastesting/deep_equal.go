...
func deepEqualAdministrativeInformation(
	...
	thatCreatedAt := that.CreatedAt()
	otherCreatedAt := other.CreatedAt()
	if (thatCreatedAt == nil && otherCreatedAt != nil) ||
		(thatCreatedAt != nil && otherCreatedAt == nil) {
		return false
	}
	if thatCreatedAt != nil {
		if *thatCreatedAt != *otherCreatedAt {
			return false
		}
	}

	thatUpdatedAt := that.UpdatedAt()
	otherUpdatedAt := other.UpdatedAt()
	if (thatUpdatedAt == nil && otherUpdatedAt != nil) ||
		(thatUpdatedAt != nil && otherUpdatedAt == nil) {
		return false
	}
	if thatUpdatedAt != nil {
		if *thatUpdatedAt != *otherUpdatedAt {
			return false
		}
	}
