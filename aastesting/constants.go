...
const RecordModeEnvironmentVariableName string = ("GITHUB_COM_FRIEDJANNIK_AAS_GO_SDK_TEST_RECORD_MODE")
...
const TestDataDirEnvironmentVariableName string = ("GITHUB_COM_FRIEDJANNIK_AAS_GO_SDK_TEST_DATA_DIR")
